...
def get_top_gainers():
    ...
    try:
        ...
        return jsonify({
            'status': 'success',
            'data': gainers.to_dict('records') if not gainers.empty else []
        })
    except Exception as e:
        return jsonify({'status': 'error', 'message': str(e)}), 500
...
def get_top_losers():
    ...
    try:
        ...
        return jsonify({
            'status': 'success',
            'data': losers.to_dict('records') if not losers.empty else []
        })
    except Exception as e:
        return jsonify({'status': 'error', 'message': str(e)}), 500
...
def get_high_volume():
    ...
    try:
        ...
        return jsonify({
            'status': 'success',
            'data': volume.to_dict('records') if not volume.empty else []
        })
    except Exception as e:
        return jsonify({'status': 'error', 'message': str(e)}), 500
